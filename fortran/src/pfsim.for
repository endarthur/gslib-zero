...
c Fixed parameters:
c
      parameter(EPSLON=1.0e-20,VERSION=3.000)
c
...
c
      ...
      ysiz  = 1.
      zsiz  = 1.  
      write(lout,201) 1,nx,ny,nz,xmn,ymn,zmn,xsiz,ysiz,zsiz,nsim
 201  format(i2,3(1x,i4),3(1x,g14.8),3(1x,g12.6),i4)
      write(lout,202)
 202  format('value')
c
